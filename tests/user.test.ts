...
describe('User account journey', () => {
    ...
    describe('Login/Logout', () => {
        ...
        describe('Login', () => {
            ...
            describe('Validity checks', () => {
                const testChanging = async <T>(attribute: string, to: T, expectedStatusCode = 400): Promise<Response> => {
                    let from = req.data.attributes[attribute];
                    req.data.attributes[attribute] = to;
                ...
                test('Non-existing user', async () => {
                    ...
                    let response = await testChanging('email', `${randomString(10)}@${randomString(5)}.com`, 404);
